...
mf_regressor = Stmf(
    mf_train_input_data=train_x_mf,
    mf_train_output_data=train_y_mf,
    mf_design=parameter_DesignSpace
)
...
plt.plot(test_x_hf_space, lcb, 'k', linewidth=.5)
plt.plot(test_x_hf_space, ucb, 'k', linewidth=.5)
