...
def test_get_discrete_names(doe: Domain):
    assert doe.get_discrete_input_names() == ["x2", "x5", "x6"]
...
def test_add_input_space():
    ...
    design.add_input_space('x6', DiscreteParameter(values=[3.14, 42]))
...
def test_add_output_space():
    ...
    design.add_output_space('x6', DiscreteParameter(values=[3.14, 42]))
...
def test_get_output_space(doe: Domain):
...
def test_cast_types_dataframe_output(doe: Domain):
    ground_truth = {
        ("input", "x1"): "float",
        ("input", "x2"): "int",
        ("input", "x3"): "float",
...
def test_get_number_of_input_parameters(design_space: Domain):
...
def test_get_number_of_output_parameters(design_space: Domain):
