"""Module that contains a wrapper for deprecated functions and classes."""
...
#                                                          Authorship & Credits
# =============================================================================
__author__ = "Optuna Hyperparameter Optimization Framework (optuna.org)"
__credits__ = ["Optuna"]
__status__ = "Stable"
# =============================================================================
#
...
def _validate_two_version(old_version: str, new_version: str) -> None:
    if version.parse(old_version) > version.parse(new_version):
        raise ValueError(
            f"Invalid version relationship. The deprecated version must be smaller than "
            f"the removed version, but (deprecated version, removed version) = ({old_version}, {new_version}) are "
            f"specified."
        )
    ...
    Args:
        ...
        text:
            ...
            .. note::
                ...
                for v{r_ver}, but this schedule is subject to change."
