#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 03:27:10
#=====================================================================#
...
#
with open('DoE49_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE49']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE49.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE49_linear_buckle, STEP=1\n')
    mode_amplitude = 9.24202e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE49']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.14627e+02\n')
    File.write('** \n')
    File.write('** \n')
