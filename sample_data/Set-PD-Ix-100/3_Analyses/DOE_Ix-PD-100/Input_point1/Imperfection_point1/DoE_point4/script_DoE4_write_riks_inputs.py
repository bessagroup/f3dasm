#=====================================================================#
#
# Created by M.A. Bessa on 11-Nov-2019 20:34:12
#=====================================================================#
...
#
with open('DoE4_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE4']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE4.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE4_linear_buckle, STEP=1\n')
    mode_amplitude = 8.63584e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE4']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -9.84616e+01\n')
    File.write('** \n')
    File.write('** \n')
