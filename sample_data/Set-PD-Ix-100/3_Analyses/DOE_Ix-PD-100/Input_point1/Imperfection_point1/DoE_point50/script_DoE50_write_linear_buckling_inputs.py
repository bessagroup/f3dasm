#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 03:27:25
#=====================================================================#
...
with open('DoE50_linear_buckle.inp','w') as File:
...
inputFile_string = '/home/gkus/F3DAS-master/3_Analyses/DOE_Ix-PD-100/Input_point1/Imperfection_point1/DoE_point50'+'/'+'DoE50_linear_buckle.inp'
job=mdb.JobFromInputFile(name='DoE50_linear_buckle', inputFileName=inputFile_string, 
