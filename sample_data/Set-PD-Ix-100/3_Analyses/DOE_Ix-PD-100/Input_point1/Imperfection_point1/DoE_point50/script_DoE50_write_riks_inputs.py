#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 03:28:05
#=====================================================================#
...
#
with open('DoE50_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE50']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE50.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE50_linear_buckle, STEP=1\n')
    mode_amplitude = 9.28556e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE50']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -7.31907e+01\n')
    File.write('** \n')
    File.write('** \n')
