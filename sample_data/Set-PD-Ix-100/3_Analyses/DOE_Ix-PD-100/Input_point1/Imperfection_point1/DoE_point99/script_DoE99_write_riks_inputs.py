#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 07:01:50
#=====================================================================#
...
#
with open('DoE99_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE99']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE99.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE99_linear_buckle, STEP=1\n')
    mode_amplitude = 5.89414e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE99']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.34190e+02\n')
    File.write('** \n')
    File.write('** \n')
