#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 05:53:40
#=====================================================================#
...
#
with open('DoE77_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE77']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE77.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE77_linear_buckle, STEP=1\n')
    mode_amplitude = 4.41615e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE77']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.22944e+02\n')
    File.write('** \n')
    File.write('** \n')
