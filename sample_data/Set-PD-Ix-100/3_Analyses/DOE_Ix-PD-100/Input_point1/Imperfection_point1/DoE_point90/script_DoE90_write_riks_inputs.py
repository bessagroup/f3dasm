#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 06:39:43
#=====================================================================#
...
#
with open('DoE90_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE90']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE90.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE90_linear_buckle, STEP=1\n')
    mode_amplitude = 4.76156e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE90']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.26265e+02\n')
    File.write('** \n')
    File.write('** \n')
