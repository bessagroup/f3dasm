# Abaqus/CAE script
# Created by M.A. Bessa (M.A.Bessa@tudelft.nl) on 12-Nov-2019 05:42:59
#
from abaqus import *
...
MastPitch = 4.76098e+01 # Pitch length of the strut (i.e. a single AstroMast!)
...
Ix = 9.58891e+01 # (Second moment of area around X axis )
...
#
mdb.Job(name='include_mesh_DoE74', model='Model-1', type=ANALYSIS, explicitPrecision=SINGLE,
...
import os
mdb.jobs['include_mesh_DoE74'].writeInput(consistencyChecking=OFF)
