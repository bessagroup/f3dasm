#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 01:04:58
#=====================================================================#
...
#
with open('DoE18_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE18']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE18.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE18_linear_buckle, STEP=1\n')
    mode_amplitude = 1.03827e-01/STRUCTURES_data['Input1']['Imperfection1']['DoE18']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.49214e+02\n')
    File.write('** \n')
    File.write('** \n')
