#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 05:30:14
#=====================================================================#
...
#
with open('DoE72_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE72']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE72.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE72_linear_buckle, STEP=1\n')
    mode_amplitude = 8.35138e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE72']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -9.39469e+01\n')
    File.write('** \n')
    File.write('** \n')
