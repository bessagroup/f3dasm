#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 02:28:34
#=====================================================================#
...
#
with open('DoE32_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE32']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE32.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE32_linear_buckle, STEP=1\n')
    mode_amplitude = 4.78788e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE32']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -7.04595e+01\n')
    File.write('** \n')
    File.write('** \n')
