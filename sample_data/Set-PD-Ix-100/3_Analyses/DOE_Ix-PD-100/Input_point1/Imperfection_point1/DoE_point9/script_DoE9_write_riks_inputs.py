#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 00:39:22
#=====================================================================#
...
#
with open('DoE9_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE9']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE9.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE9_linear_buckle, STEP=1\n')
    mode_amplitude = 1.91690e-01/STRUCTURES_data['Input1']['Imperfection1']['DoE9']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.28424e+02\n')
    File.write('** \n')
    File.write('** \n')
