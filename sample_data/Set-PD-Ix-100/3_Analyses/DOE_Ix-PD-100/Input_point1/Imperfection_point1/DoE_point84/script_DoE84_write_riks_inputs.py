#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 06:16:29
#=====================================================================#
...
#
with open('DoE84_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE84']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE84.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE84_linear_buckle, STEP=1\n')
    mode_amplitude = 1.06857e-01/STRUCTURES_data['Input1']['Imperfection1']['DoE84']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -7.18616e+01\n')
    File.write('** \n')
    File.write('** \n')
