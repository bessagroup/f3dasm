#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 04:43:10
#=====================================================================#
...
#
with open('DoE59_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE59']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE59.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE59_linear_buckle, STEP=1\n')
    mode_amplitude = 6.27516e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE59']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -4.40789e+01\n')
    File.write('** \n')
    File.write('** \n')
