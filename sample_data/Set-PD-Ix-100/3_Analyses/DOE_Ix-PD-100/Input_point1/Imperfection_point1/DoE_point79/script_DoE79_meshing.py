# Abaqus/CAE script
# Created by M.A. Bessa (M.A.Bessa@tudelft.nl) on 12-Nov-2019 05:59:51
#
from abaqus import *
...
#------------------------------------------------------------
os.chdir(r'/home/gkus/F3DAS-master/3_Analyses/DOE_Ix-PD-100/Input_point1/Imperfection_point1/DoE_point79')
#
#-------------------------------------------------------------
# Parameters:
...
MastPitch = 5.70700e+01 # Pitch length of the strut (i.e. a single AstroMast!)
pinned_joints = 1 # (1 = batten are pinned to longerons, 0 = battens and longerons are a solid piece)
Longeron_CS = 1.00000e+01 # (Cross Section of the longeron)
Ix = 7.17952e+01 # (Second moment of area around X axis )
...
#
mdb.Job(name='include_mesh_DoE79', model='Model-1', type=ANALYSIS, explicitPrecision=SINGLE,
...
import os
mdb.jobs['include_mesh_DoE79'].writeInput(consistencyChecking=OFF)
