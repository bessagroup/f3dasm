#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 06:00:21
#=====================================================================#
...
#
with open('DoE79_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE79']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE79.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE79_linear_buckle, STEP=1\n')
    mode_amplitude = 6.36460e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE79']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -5.70700e+01\n')
    File.write('** \n')
    File.write('** \n')
