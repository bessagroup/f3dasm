#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 05:19:12
#=====================================================================#
...
#
with open('DoE69_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE69']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE69.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE69_linear_buckle, STEP=1\n')
    mode_amplitude = 4.90955e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE69']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.27144e+02\n')
    File.write('** \n')
    File.write('** \n')
