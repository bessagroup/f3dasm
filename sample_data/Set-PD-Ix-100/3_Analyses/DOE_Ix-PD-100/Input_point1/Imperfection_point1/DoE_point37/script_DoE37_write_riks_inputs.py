#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 02:38:23
#=====================================================================#
...
#
with open('DoE37_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE37']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE37.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE37_linear_buckle, STEP=1\n')
    mode_amplitude = 7.37639e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE37']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -6.30310e+01\n')
    File.write('** \n')
    File.write('** \n')
