#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 06:13:39
#=====================================================================#
...
#
with open('DoE83_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE83']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE83.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE83_linear_buckle, STEP=1\n')
    mode_amplitude = 7.10565e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE83']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -9.27625e+01\n')
    File.write('** \n')
    File.write('** \n')
