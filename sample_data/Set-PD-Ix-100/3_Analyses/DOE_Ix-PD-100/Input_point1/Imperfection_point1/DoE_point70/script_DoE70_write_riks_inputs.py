#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 05:25:55
#=====================================================================#
...
#
with open('DoE70_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE70']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE70.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE70_linear_buckle, STEP=1\n')
    mode_amplitude = 1.33674e-01/STRUCTURES_data['Input1']['Imperfection1']['DoE70']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -2.69816e+01\n')
    File.write('** \n')
    File.write('** \n')
