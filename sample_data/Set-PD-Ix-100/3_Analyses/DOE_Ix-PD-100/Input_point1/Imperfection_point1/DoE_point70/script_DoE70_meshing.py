# Abaqus/CAE script
# Created by M.A. Bessa (M.A.Bessa@tudelft.nl) on 12-Nov-2019 05:25:18
#
from abaqus import *
...
#------------------------------------------------------------
os.chdir(r'/home/gkus/F3DAS-master/3_Analyses/DOE_Ix-PD-100/Input_point1/Imperfection_point1/DoE_point70')
#
#-------------------------------------------------------------
# Parameters:
...
MastPitch = 2.69816e+01 # Pitch length of the strut (i.e. a single AstroMast!)
...
Ix = 1.35096e+02 # (Second moment of area around X axis )
...
Gmodulus = 6.57367e+02 # (Shear Modulus)
nu = 3.88874e-01 # (Poisson Ratio)
...
#
mdb.Job(name='include_mesh_DoE70', model='Model-1', type=ANALYSIS, explicitPrecision=SINGLE,
...
import os
mdb.jobs['include_mesh_DoE70'].writeInput(consistencyChecking=OFF)
