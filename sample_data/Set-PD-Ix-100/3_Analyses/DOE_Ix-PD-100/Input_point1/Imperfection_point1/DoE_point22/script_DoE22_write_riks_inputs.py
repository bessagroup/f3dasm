#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 01:18:26
#=====================================================================#
...
#
with open('DoE22_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE22']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE22.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE22_linear_buckle, STEP=1\n')
    mode_amplitude = 4.70371e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE22']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.25351e+02\n')
    File.write('** \n')
    File.write('** \n')
