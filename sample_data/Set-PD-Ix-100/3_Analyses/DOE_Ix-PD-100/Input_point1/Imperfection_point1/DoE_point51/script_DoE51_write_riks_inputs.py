#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 03:37:28
#=====================================================================#
...
#
with open('DoE51_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE51']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE51.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE51_linear_buckle, STEP=1\n')
    mode_amplitude = 5.20327e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE51']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -5.56182e+01\n')
    File.write('** \n')
    File.write('** \n')
