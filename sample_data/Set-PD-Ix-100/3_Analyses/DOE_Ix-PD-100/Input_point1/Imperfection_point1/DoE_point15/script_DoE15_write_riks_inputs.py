#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 00:54:10
#=====================================================================#
...
#
with open('DoE15_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE15']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE15.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE15_linear_buckle, STEP=1\n')
    mode_amplitude = 8.27006e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE15']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -7.62926e+01\n')
    File.write('** \n')
    File.write('** \n')
