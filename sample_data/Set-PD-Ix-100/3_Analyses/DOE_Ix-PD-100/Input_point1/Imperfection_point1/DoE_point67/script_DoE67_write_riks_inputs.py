#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 05:09:30
#=====================================================================#
...
#
with open('DoE67_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE67']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE67.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE67_linear_buckle, STEP=1\n')
    mode_amplitude = 4.32732e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE67']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -7.76982e+01\n')
    File.write('** \n')
    File.write('** \n')
