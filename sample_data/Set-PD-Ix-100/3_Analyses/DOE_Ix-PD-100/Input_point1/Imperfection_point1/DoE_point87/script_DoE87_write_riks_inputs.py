#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 06:31:45
#=====================================================================#
...
#
with open('DoE87_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE87']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE87.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE87_linear_buckle, STEP=1\n')
    mode_amplitude = 8.56745e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE87']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.15397e+02\n')
    File.write('** \n')
    File.write('** \n')
