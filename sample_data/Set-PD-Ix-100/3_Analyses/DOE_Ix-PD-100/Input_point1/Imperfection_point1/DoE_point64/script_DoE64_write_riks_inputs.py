#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 04:51:13
#=====================================================================#
...
#
with open('DoE64_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE64']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE64.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE64_linear_buckle, STEP=1\n')
    mode_amplitude = 9.26197e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE64']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.19627e+02\n')
    File.write('** \n')
    File.write('** \n')
