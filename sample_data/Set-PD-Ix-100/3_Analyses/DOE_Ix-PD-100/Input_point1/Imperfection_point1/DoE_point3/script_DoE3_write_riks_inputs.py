#=====================================================================#
#
# Created by M.A. Bessa on 11-Nov-2019 20:27:52
#=====================================================================#
...
#
with open('DoE3_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE3']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE3.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE3_linear_buckle, STEP=1\n')
    mode_amplitude = 3.45462e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE3']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -5.78616e+01\n')
    File.write('** \n')
    File.write('** \n')
