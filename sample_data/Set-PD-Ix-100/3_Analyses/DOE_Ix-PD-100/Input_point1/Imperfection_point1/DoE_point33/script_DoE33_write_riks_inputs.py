#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 02:31:44
#=====================================================================#
...
#
with open('DoE33_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE33']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE33.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE33_linear_buckle, STEP=1\n')
    mode_amplitude = 4.89906e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE33']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -8.65346e+01\n')
    File.write('** \n')
    File.write('** \n')
