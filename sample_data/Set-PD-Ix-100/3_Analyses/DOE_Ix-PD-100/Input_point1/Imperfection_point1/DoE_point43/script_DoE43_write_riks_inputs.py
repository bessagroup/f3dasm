#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 03:07:50
#=====================================================================#
...
#
with open('DoE43_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE43']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE43.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE43_linear_buckle, STEP=1\n')
    mode_amplitude = 7.36344e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE43']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.41503e+02\n')
    File.write('** \n')
    File.write('** \n')
