#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 02:19:48
#=====================================================================#
...
#
with open('DoE29_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE29']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE29.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE29_linear_buckle, STEP=1\n')
    mode_amplitude = 7.30888e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE29']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -2.55435e+01\n')
    File.write('** \n')
    File.write('** \n')
