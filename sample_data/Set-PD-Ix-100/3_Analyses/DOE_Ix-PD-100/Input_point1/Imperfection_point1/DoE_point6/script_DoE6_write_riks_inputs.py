#=====================================================================#
#
# Created by M.A. Bessa on 11-Nov-2019 20:43:08
#=====================================================================#
...
#
with open('DoE6_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE6']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE6.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE6_linear_buckle, STEP=1\n')
    mode_amplitude = 4.56736e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE6']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -4.68183e+01\n')
    File.write('** \n')
    File.write('** \n')
