#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 04:46:49
#=====================================================================#
...
#
with open('DoE62_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE62']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE62.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE62_linear_buckle, STEP=1\n')
    mode_amplitude = 6.76917e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE62']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -6.06163e+01\n')
    File.write('** \n')
    File.write('** \n')
