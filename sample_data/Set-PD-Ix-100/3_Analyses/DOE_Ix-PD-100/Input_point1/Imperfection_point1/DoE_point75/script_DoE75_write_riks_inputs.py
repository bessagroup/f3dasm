#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 05:46:51
#=====================================================================#
...
#
with open('DoE75_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE75']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE75.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE75_linear_buckle, STEP=1\n')
    mode_amplitude = 5.35640e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE75']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -8.08073e+01\n')
    File.write('** \n')
    File.write('** \n')
