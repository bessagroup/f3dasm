#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 02:36:41
#=====================================================================#
...
#
with open('DoE36_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE36']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE36.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE36_linear_buckle, STEP=1\n')
    mode_amplitude = 1.02274e-01/STRUCTURES_data['Input1']['Imperfection1']['DoE36']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -4.16031e+01\n')
    File.write('** \n')
    File.write('** \n')
