#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 02:44:30
#=====================================================================#
...
#
with open('DoE41_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE41']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE41.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE41_linear_buckle, STEP=1\n')
    mode_amplitude = 6.50653e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE41']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -7.56054e+01\n')
    File.write('** \n')
    File.write('** \n')
