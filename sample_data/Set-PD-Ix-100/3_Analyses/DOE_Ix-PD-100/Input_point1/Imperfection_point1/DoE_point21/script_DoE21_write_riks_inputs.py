#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 01:16:05
#=====================================================================#
...
#
with open('DoE21_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE21']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE21.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE21_linear_buckle, STEP=1\n')
    mode_amplitude = 8.16573e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE21']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -3.70752e+01\n')
    File.write('** \n')
    File.write('** \n')
