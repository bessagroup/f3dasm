#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 02:42:58
#=====================================================================#
...
#
with open('DoE40_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE40']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE40.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE40_linear_buckle, STEP=1\n')
    mode_amplitude = 4.05677e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE40']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -3.37399e+01\n')
    File.write('** \n')
    File.write('** \n')
