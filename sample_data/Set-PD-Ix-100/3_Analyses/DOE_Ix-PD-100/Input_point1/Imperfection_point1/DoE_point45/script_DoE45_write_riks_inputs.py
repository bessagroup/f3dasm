#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 03:16:31
#=====================================================================#
...
#
with open('DoE45_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE45']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE45.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE45_linear_buckle, STEP=1\n')
    mode_amplitude = 5.20139e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE45']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -6.61477e+01\n')
    File.write('** \n')
    File.write('** \n')
