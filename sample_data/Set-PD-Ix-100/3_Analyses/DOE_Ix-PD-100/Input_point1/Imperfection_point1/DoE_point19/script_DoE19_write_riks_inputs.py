#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 01:12:12
#=====================================================================#
...
#
with open('DoE19_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE19']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE19.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE19_linear_buckle, STEP=1\n')
    mode_amplitude = 1.01397e-01/STRUCTURES_data['Input1']['Imperfection1']['DoE19']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.04298e+02\n')
    File.write('** \n')
    File.write('** \n')
