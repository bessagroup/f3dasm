#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 05:52:48
#=====================================================================#
...
#
with open('DoE76_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE76']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE76.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE76_linear_buckle, STEP=1\n')
    mode_amplitude = 4.44229e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE76']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.06766e+02\n')
    File.write('** \n')
    File.write('** \n')
