#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 02:16:22
#=====================================================================#
...
#
with open('DoE28_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE28']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE28.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE28_linear_buckle, STEP=1\n')
    mode_amplitude = 6.13336e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE28']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -7.91974e+01\n')
    File.write('** \n')
    File.write('** \n')
