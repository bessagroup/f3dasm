#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 06:43:43
#=====================================================================#
...
#
with open('DoE94_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE94']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE94.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE94_linear_buckle, STEP=1\n')
    mode_amplitude = 1.43223e-01/STRUCTURES_data['Input1']['Imperfection1']['DoE94']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.48297e+02\n')
    File.write('** \n')
    File.write('** \n')
