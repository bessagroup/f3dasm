# Abaqus/CAE script
# Created by M.A. Bessa (M.A.Bessa@tudelft.nl) on 12-Nov-2019 06:41:57
#
from abaqus import *
...
MastPitch = 4.53801e+01 # Pitch length of the strut (i.e. a single AstroMast!)
...
Ix = 1.34179e+01 # (Second moment of area around X axis )
...
#
mdb.Job(name='include_mesh_DoE93', model='Model-1', type=ANALYSIS, explicitPrecision=SINGLE,
...
import os
mdb.jobs['include_mesh_DoE93'].writeInput(consistencyChecking=OFF)
