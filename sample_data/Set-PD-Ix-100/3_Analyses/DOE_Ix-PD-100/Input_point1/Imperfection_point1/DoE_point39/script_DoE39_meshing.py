# Abaqus/CAE script
# Created by M.A. Bessa (M.A.Bessa@tudelft.nl) on 12-Nov-2019 02:40:10
#
from abaqus import *
...
#------------------------------------------------------------
os.chdir(r'/home/gkus/F3DAS-master/3_Analyses/DOE_Ix-PD-100/Input_point1/Imperfection_point1/DoE_point39')
#
#-------------------------------------------------------------
# Parameters:
...
MastPitch = 1.21119e+02 # Pitch length of the strut (i.e. a single AstroMast!)
pinned_joints = 1 # (1 = batten are pinned to longerons, 0 = battens and longerons are a solid piece)
Longeron_CS = 1.00001e+01 # (Cross Section of the longeron)
Ix = 1.70031e+00 # (Second moment of area around X axis )
...
Gmodulus = 6.57365e+02 # (Shear Modulus)
nu = 3.88878e-01 # (Poisson Ratio)
...
#
mdb.Job(name='include_mesh_DoE39', model='Model-1', type=ANALYSIS, explicitPrecision=SINGLE,
...
import os
mdb.jobs['include_mesh_DoE39'].writeInput(consistencyChecking=OFF)
