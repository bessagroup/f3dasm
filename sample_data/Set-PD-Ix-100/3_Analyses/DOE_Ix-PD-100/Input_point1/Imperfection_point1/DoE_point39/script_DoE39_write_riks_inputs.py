#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 02:40:43
#=====================================================================#
...
#
with open('DoE39_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE39']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE39.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE39_linear_buckle, STEP=1\n')
    mode_amplitude = 1.00250e-01/STRUCTURES_data['Input1']['Imperfection1']['DoE39']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.21119e+02\n')
    File.write('** \n')
    File.write('** \n')
