#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 07:00:47
#=====================================================================#
...
#
with open('DoE98_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE98']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE98.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE98_linear_buckle, STEP=1\n')
    mode_amplitude = 3.80137e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE98']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -8.92620e+01\n')
    File.write('** \n')
    File.write('** \n')
