#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 03:18:31
#=====================================================================#
...
#
with open('DoE46_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE46']['coilable'][0] == 0:
    ...
    File.write('*IMPERFECTION, FILE=DoE46_linear_buckle, STEP=1\n')
    mode_amplitude = 6.64590e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE46']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -8.82225e+01\n')
    File.write('** \n')
    File.write('** \n')
