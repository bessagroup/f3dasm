# Abaqus/CAE script
# Created by M.A. Bessa (M.A.Bessa@tudelft.nl) on 12-Nov-2019 03:18:03
#
from abaqus import *
...
MastPitch = 8.82225e+01 # Pitch length of the strut (i.e. a single AstroMast!)
...
Ix = 6.50948e+01 # (Second moment of area around X axis )
...
#
mdb.Job(name='include_mesh_DoE46', model='Model-1', type=ANALYSIS, explicitPrecision=SINGLE,
...
import os
mdb.jobs['include_mesh_DoE46'].writeInput(consistencyChecking=OFF)
