#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 03:25:16
#=====================================================================#
...
#
with open('DoE47_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE47']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE47.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE47_linear_buckle, STEP=1\n')
    mode_amplitude = 6.38799e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE47']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.33154e+02\n')
    File.write('** \n')
    File.write('** \n')
