#=====================================================================#
#
# Created by M.A. Bessa on 11-Nov-2019 19:19:41
#=====================================================================#
...
with open('DoE1_linear_buckle.inp','w') as File:
    File.write('** Include file with mesh of structure:\n')
    File.write('*INCLUDE, INPUT=include_mesh_DoE1.inp\n')
    File.write('** \n')
...
inputFile_string = '/home/gkus/F3DAS-master/3_Analyses/DOE_Ix-PD-100/Input_point1/Imperfection_point1/DoE_point1'+'/'+'DoE1_linear_buckle.inp'
job=mdb.JobFromInputFile(name='DoE1_linear_buckle', inputFileName=inputFile_string, 
