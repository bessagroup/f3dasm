#=====================================================================#
#
# Created by M.A. Bessa on 11-Nov-2019 19:52:38
#=====================================================================#
...
#
with open('DoE1_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE1']['coilable'][0] == 0:
    ...
    File.write('*IMPERFECTION, FILE=DoE1_linear_buckle, STEP=1\n')
    mode_amplitude = 7.85114e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE1']['maxDisp_p3'][1]
