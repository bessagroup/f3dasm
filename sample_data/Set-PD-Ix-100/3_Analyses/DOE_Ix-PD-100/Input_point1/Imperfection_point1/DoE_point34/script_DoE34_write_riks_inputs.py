#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 02:32:42
#=====================================================================#
...
#
with open('DoE34_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE34']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE34.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE34_linear_buckle, STEP=1\n')
    mode_amplitude = 5.28665e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE34']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.08607e+02\n')
    File.write('** \n')
    File.write('** \n')
