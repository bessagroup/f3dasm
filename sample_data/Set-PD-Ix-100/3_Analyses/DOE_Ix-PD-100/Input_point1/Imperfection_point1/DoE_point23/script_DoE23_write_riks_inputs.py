#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 01:19:02
#=====================================================================#
...
#
with open('DoE23_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE23']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE23.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE23_linear_buckle, STEP=1\n')
    mode_amplitude = 8.27612e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE23']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -9.60450e+01\n')
    File.write('** \n')
    File.write('** \n')
