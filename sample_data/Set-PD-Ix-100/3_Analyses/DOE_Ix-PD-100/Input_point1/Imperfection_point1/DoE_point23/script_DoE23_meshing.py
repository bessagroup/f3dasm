...
#------------------------------------------------------------
os.chdir(r'/home/gkus/F3DAS-master/3_Analyses/DOE_Ix-PD-100/Input_point1/Imperfection_point1/DoE_point23')
#
#-------------------------------------------------------------
# Parameters:
...
MastPitch = 9.60450e+01 # Pitch length of the strut (i.e. a single AstroMast!)
...
Ix = 5.82346e+01 # (Second moment of area around X axis )
...
#
mdb.Job(name='include_mesh_DoE23', model='Model-1', type=ANALYSIS, explicitPrecision=SINGLE,
...
import os
mdb.jobs['include_mesh_DoE23'].writeInput(consistencyChecking=OFF)
