# Abaqus/CAE script
# Created by M.A. Bessa (M.A.Bessa@tudelft.nl) on 12-Nov-2019 06:22:44
#
from abaqus import *
...
#------------------------------------------------------------
os.chdir(r'/home/gkus/F3DAS-master/3_Analyses/DOE_Ix-PD-100/Input_point1/Imperfection_point1/DoE_point86')
#
#-------------------------------------------------------------
# Parameters:
...
MastPitch = 1.36887e+02 # Pitch length of the strut (i.e. a single AstroMast!)
pinned_joints = 1 # (1 = batten are pinned to longerons, 0 = battens and longerons are a solid piece)
Longeron_CS = 1.00009e+01 # (Cross Section of the longeron)
Ix = 2.05128e+01 # (Second moment of area around X axis )
...
Gmodulus = 6.57364e+02 # (Shear Modulus)
nu = 3.88881e-01 # (Poisson Ratio)
...
#
mdb.Job(name='include_mesh_DoE86', model='Model-1', type=ANALYSIS, explicitPrecision=SINGLE,
...
import os
mdb.jobs['include_mesh_DoE86'].writeInput(consistencyChecking=OFF)
