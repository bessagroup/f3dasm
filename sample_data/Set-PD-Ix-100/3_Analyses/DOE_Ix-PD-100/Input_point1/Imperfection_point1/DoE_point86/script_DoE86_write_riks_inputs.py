#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 06:23:29
#=====================================================================#
...
#
with open('DoE86_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE86']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE86.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE86_linear_buckle, STEP=1\n')
    mode_amplitude = 8.22619e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE86']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.36887e+02\n')
    File.write('** \n')
    File.write('** \n')
