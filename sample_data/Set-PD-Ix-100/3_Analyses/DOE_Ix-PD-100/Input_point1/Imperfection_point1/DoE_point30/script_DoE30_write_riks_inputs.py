#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 02:21:35
#=====================================================================#
...
#
with open('DoE30_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE30']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE30.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE30_linear_buckle, STEP=1\n')
    mode_amplitude = 5.32124e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE30']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.28582e+02\n')
    File.write('** \n')
    File.write('** \n')
