#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 02:39:54
#=====================================================================#
...
#
with open('DoE38_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE38']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE38.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE38_linear_buckle, STEP=1\n')
    mode_amplitude = 5.37202e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE38']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -9.96400e+01\n')
    File.write('** \n')
    File.write('** \n')
