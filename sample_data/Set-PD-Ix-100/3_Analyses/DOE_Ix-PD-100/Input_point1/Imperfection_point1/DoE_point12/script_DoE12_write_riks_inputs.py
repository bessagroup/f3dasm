#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 00:44:39
#=====================================================================#
...
#
with open('DoE12_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE12']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE12.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE12_linear_buckle, STEP=1\n')
    mode_amplitude = 1.63423e-01/STRUCTURES_data['Input1']['Imperfection1']['DoE12']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -9.52306e+01\n')
    File.write('** \n')
    File.write('** \n')
