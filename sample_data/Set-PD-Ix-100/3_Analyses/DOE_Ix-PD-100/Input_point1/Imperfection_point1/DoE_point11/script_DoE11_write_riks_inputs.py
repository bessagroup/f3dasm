#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 00:42:56
#=====================================================================#
...
#
with open('DoE11_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE11']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE11.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE11_linear_buckle, STEP=1\n')
    mode_amplitude = 4.51113e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE11']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -6.93933e+01\n')
    File.write('** \n')
    File.write('** \n')
