# Abaqus/CAE script
# Created by M.A. Bessa (M.A.Bessa@tudelft.nl) on 12-Nov-2019 07:04:45
#
from abaqus import *
...
MastPitch = 3.01903e+01 # Pitch length of the strut (i.e. a single AstroMast!)
...
Ix = 9.37923e+01 # (Second moment of area around X axis )
...
#
mdb.Job(name='include_mesh_DoE100', model='Model-1', type=ANALYSIS, explicitPrecision=SINGLE,
...
import os
mdb.jobs['include_mesh_DoE100'].writeInput(consistencyChecking=OFF)
