#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 07:05:16
#=====================================================================#
...
#
with open('DoE100_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE100']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE100.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE100_linear_buckle, STEP=1\n')
    mode_amplitude = 3.95893e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE100']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -3.01903e+01\n')
    File.write('** \n')
    File.write('** \n')
