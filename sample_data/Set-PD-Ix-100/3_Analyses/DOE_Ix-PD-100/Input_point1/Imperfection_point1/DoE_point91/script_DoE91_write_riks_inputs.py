#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 06:40:10
#=====================================================================#
...
#
with open('DoE91_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE91']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE91.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE91_linear_buckle, STEP=1\n')
    mode_amplitude = 4.78664e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE91']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -9.69626e+01\n')
    File.write('** \n')
    File.write('** \n')
