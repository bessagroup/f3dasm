# Abaqus/CAE script
# Created by M.A. Bessa (M.A.Bessa@tudelft.nl) on 12-Nov-2019 04:45:53
#
from abaqus import *
...
MastPitch = 1.02055e+02 # Pitch length of the strut (i.e. a single AstroMast!)
...
Ix = 8.95581e+01 # (Second moment of area around X axis )
...
#
mdb.Job(name='include_mesh_DoE61', model='Model-1', type=ANALYSIS, explicitPrecision=SINGLE,
...
import os
mdb.jobs['include_mesh_DoE61'].writeInput(consistencyChecking=OFF)
