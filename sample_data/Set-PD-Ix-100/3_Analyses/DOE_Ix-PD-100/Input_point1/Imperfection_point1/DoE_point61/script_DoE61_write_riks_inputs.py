#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 04:46:16
#=====================================================================#
...
#
os.chdir(r'/home/gkus/F3DAS-master/3_Analyses/DOE_Ix-PD-100/Input_point1/Imperfection_point1/DoE_point61')
...
#
with open('DoE61_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE61']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE61.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE61_linear_buckle, STEP=1\n')
    mode_amplitude = 4.87010e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE61']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.02055e+02\n')
    File.write('** \n')
    File.write('** \n')
