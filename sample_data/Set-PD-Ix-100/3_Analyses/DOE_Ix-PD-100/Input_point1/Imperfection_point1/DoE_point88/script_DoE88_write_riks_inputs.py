#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 06:32:36
#=====================================================================#
...
#
with open('DoE88_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE88']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE88.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE88_linear_buckle, STEP=1\n')
    mode_amplitude = 6.24185e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE88']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -7.77917e+01\n')
    File.write('** \n')
    File.write('** \n')
