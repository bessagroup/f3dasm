#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 01:30:30
#=====================================================================#
...
#
with open('DoE25_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE25']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE25.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE25_linear_buckle, STEP=1\n')
    mode_amplitude = 7.73953e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE25']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -4.98910e+01\n')
    File.write('** \n')
    File.write('** \n')
