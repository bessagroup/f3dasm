# Abaqus/CAE script
# Created by M.A. Bessa (M.A.Bessa@tudelft.nl) on 12-Nov-2019 01:29:36
#
from abaqus import *
...
#------------------------------------------------------------
os.chdir(r'/home/gkus/F3DAS-master/3_Analyses/DOE_Ix-PD-100/Input_point1/Imperfection_point1/DoE_point25')
#
#-------------------------------------------------------------
# Parameters:
...
MastPitch = 4.98910e+01 # Pitch length of the strut (i.e. a single AstroMast!)
...
Ix = 6.73652e+01 # (Second moment of area around X axis )
...
#
mdb.Job(name='include_mesh_DoE25', model='Model-1', type=ANALYSIS, explicitPrecision=SINGLE,
...
import os
mdb.jobs['include_mesh_DoE25'].writeInput(consistencyChecking=OFF)
