#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 04:45:42
#=====================================================================#
...
#
with open('DoE60_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE60']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE60.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE60_linear_buckle, STEP=1\n')
    mode_amplitude = 9.30761e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE60']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.43250e+02\n')
    File.write('** \n')
    File.write('** \n')
