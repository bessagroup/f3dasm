#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 02:35:50
#=====================================================================#
...
#
with open('DoE35_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE35']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE35.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE35_linear_buckle, STEP=1\n')
    mode_amplitude = 2.82497e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE35']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.45726e+02\n')
    File.write('** \n')
    File.write('** \n')
