#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 01:34:21
#=====================================================================#
...
#
with open('DoE27_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE27']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE27.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE27_linear_buckle, STEP=1\n')
    mode_amplitude = 8.29959e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE27']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.16676e+02\n')
    File.write('** \n')
    File.write('** \n')
