# Abaqus/CAE script
# Created by M.A. Bessa (M.A.Bessa@tudelft.nl) on 12-Nov-2019 03:47:25
#
from abaqus import *
...
#------------------------------------------------------------
os.chdir(r'/home/gkus/F3DAS-master/3_Analyses/DOE_Ix-PD-100/Input_point1/Imperfection_point1/DoE_point54')
#
#-------------------------------------------------------------
# Parameters:
...
MastPitch = 6.47170e+01 # Pitch length of the strut (i.e. a single AstroMast!)
...
Ix = 8.67789e+01 # (Second moment of area around X axis )
...
Gmodulus = 6.57376e+02 # (Shear Modulus)
nu = 3.88855e-01 # (Poisson Ratio)
...
#
mdb.Job(name='include_mesh_DoE54', model='Model-1', type=ANALYSIS, explicitPrecision=SINGLE,
...
import os
mdb.jobs['include_mesh_DoE54'].writeInput(consistencyChecking=OFF)
