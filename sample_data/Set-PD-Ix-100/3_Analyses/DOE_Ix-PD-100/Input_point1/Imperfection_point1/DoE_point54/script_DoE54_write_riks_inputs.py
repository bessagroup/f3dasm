#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 03:47:47
#=====================================================================#
...
#
with open('DoE54_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE54']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE54.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE54_linear_buckle, STEP=1\n')
    mode_amplitude = 4.83529e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE54']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -6.47170e+01\n')
    File.write('** \n')
    File.write('** \n')
