#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 03:07:18
#=====================================================================#
...
#
with open('DoE42_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE42']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE42.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE42_linear_buckle, STEP=1\n')
    mode_amplitude = 6.24600e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE42']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.12212e+02\n')
    File.write('** \n')
    File.write('** \n')
