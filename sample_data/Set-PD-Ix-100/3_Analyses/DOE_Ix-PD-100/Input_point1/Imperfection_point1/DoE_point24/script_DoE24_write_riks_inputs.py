#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 01:27:41
#=====================================================================#
...
#
with open('DoE24_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE24']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE24.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE24_linear_buckle, STEP=1\n')
    mode_amplitude = 1.08200e-01/STRUCTURES_data['Input1']['Imperfection1']['DoE24']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -5.85693e+01\n')
    File.write('** \n')
    File.write('** \n')
