#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 01:27:19
#=====================================================================#
...
with open('DoE24_linear_buckle.inp','w') as File:
...
inputFile_string = '/home/gkus/F3DAS-master/3_Analyses/DOE_Ix-PD-100/Input_point1/Imperfection_point1/DoE_point24'+'/'+'DoE24_linear_buckle.inp'
job=mdb.JobFromInputFile(name='DoE24_linear_buckle', inputFileName=inputFile_string, 
