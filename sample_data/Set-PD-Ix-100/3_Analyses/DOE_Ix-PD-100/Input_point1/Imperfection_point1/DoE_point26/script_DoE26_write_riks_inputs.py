#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 01:33:11
#=====================================================================#
...
#
with open('DoE26_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE26']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE26.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE26_linear_buckle, STEP=1\n')
    mode_amplitude = 9.08447e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE26']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.38171e+02\n')
    File.write('** \n')
    File.write('** \n')
