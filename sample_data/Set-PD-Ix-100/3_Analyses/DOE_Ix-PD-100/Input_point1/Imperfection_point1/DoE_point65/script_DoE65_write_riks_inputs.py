#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 05:06:47
#=====================================================================#
...
#
with open('DoE65_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE65']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE65.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE65_linear_buckle, STEP=1\n')
    mode_amplitude = 1.05502e-01/STRUCTURES_data['Input1']['Imperfection1']['DoE65']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.35763e+02\n')
    File.write('** \n')
    File.write('** \n')
