# Abaqus/CAE script
# Created by M.A. Bessa (M.A.Bessa@tudelft.nl) on 12-Nov-2019 05:06:25
#
from abaqus import *
...
#------------------------------------------------------------
os.chdir(r'/home/gkus/F3DAS-master/3_Analyses/DOE_Ix-PD-100/Input_point1/Imperfection_point1/DoE_point65')
#
#-------------------------------------------------------------
# Parameters:
...
MastPitch = 1.35763e+02 # Pitch length of the strut (i.e. a single AstroMast!)
...
Ix = 8.00383e+01 # (Second moment of area around X axis )
...
#
mdb.Job(name='include_mesh_DoE65', model='Model-1', type=ANALYSIS, explicitPrecision=SINGLE,
...
import os
mdb.jobs['include_mesh_DoE65'].writeInput(consistencyChecking=OFF)
