#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 05:07:40
#=====================================================================#
...
#
with open('DoE66_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE66']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE66.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE66_linear_buckle, STEP=1\n')
    mode_amplitude = 6.87607e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE66']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -5.22982e+01\n')
    File.write('** \n')
    File.write('** \n')
