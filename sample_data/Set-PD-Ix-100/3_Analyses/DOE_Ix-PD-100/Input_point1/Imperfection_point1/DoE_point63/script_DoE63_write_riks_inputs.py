#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 04:49:20
#=====================================================================#
...
#
with open('DoE63_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE63']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE63.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE63_linear_buckle, STEP=1\n')
    mode_amplitude = 7.88547e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE63']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -3.52313e+01\n')
    File.write('** \n')
    File.write('** \n')
