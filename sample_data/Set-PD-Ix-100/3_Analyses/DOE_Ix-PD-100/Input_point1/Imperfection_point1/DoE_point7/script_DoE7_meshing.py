# Abaqus/CAE script
# Created by M.A. Bessa (M.A.Bessa@tudelft.nl) on 11-Nov-2019 21:13:55
#
from abaqus import *
...
#------------------------------------------------------------
os.chdir(r'/home/gkus/F3DAS-master/3_Analyses/DOE_Ix-PD-100/Input_point1/Imperfection_point1/DoE_point7')
#
#-------------------------------------------------------------
# Parameters:
...
MastPitch = 8.00118e+01 # Pitch length of the strut (i.e. a single AstroMast!)
...
Ix = 1.00730e+02 # (Second moment of area around X axis )
...
#
mdb.Job(name='include_mesh_DoE7', model='Model-1', type=ANALYSIS, explicitPrecision=SINGLE,
...
import os
mdb.jobs['include_mesh_DoE7'].writeInput(consistencyChecking=OFF)
