#=====================================================================#
#
# Created by M.A. Bessa on 11-Nov-2019 21:40:14
#=====================================================================#
...
#
with open('DoE7_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE7']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE7.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE7_linear_buckle, STEP=1\n')
    mode_amplitude = 5.90344e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE7']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -8.00118e+01\n')
    File.write('** \n')
    File.write('** \n')
