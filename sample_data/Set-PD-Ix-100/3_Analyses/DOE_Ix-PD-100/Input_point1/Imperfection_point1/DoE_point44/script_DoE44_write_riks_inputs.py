#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 03:14:42
#=====================================================================#
...
#
with open('DoE44_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE44']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE44.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE44_linear_buckle, STEP=1\n')
    mode_amplitude = 7.34973e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE44']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -5.41269e+01\n')
    File.write('** \n')
    File.write('** \n')
