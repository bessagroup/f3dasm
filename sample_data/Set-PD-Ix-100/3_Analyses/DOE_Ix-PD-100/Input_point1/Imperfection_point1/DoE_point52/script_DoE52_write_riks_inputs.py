#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 03:39:52
#=====================================================================#
...
#
with open('DoE52_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE52']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE52.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE52_linear_buckle, STEP=1\n')
    mode_amplitude = 6.85879e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE52']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.40012e+02\n')
    File.write('** \n')
    File.write('** \n')
