#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 06:38:30
#=====================================================================#
...
#
with open('DoE89_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE89']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE89.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE89_linear_buckle, STEP=1\n')
    mode_amplitude = 7.14300e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE89']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -3.78707e+01\n')
    File.write('** \n')
    File.write('** \n')
