#=====================================================================#
#
# Created by M.A. Bessa on 11-Nov-2019 20:01:24
#=====================================================================#
...
#
with open('DoE2_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE2']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE2.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE2_linear_buckle, STEP=1\n')
    mode_amplitude = 1.14866e-01/STRUCTURES_data['Input1']['Imperfection1']['DoE2']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -4.02777e+01\n')
    File.write('** \n')
    File.write('** \n')
