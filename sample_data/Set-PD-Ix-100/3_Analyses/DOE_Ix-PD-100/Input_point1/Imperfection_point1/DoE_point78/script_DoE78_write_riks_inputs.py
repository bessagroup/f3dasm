#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 05:54:29
#=====================================================================#
...
#
with open('DoE78_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE78']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE78.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE78_linear_buckle, STEP=1\n')
    mode_amplitude = 7.73794e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE78']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -3.94825e+01\n')
    File.write('** \n')
    File.write('** \n')
