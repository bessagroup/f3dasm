# Abaqus/CAE script
# Created by M.A. Bessa (M.A.Bessa@tudelft.nl) on 12-Nov-2019 05:53:52
#
from abaqus import *
...
#------------------------------------------------------------
os.chdir(r'/home/gkus/F3DAS-master/3_Analyses/DOE_Ix-PD-100/Input_point1/Imperfection_point1/DoE_point78')
#
#-------------------------------------------------------------
# Parameters:
...
MastPitch = 3.94825e+01 # Pitch length of the strut (i.e. a single AstroMast!)
...
Ix = 6.50337e-01 # (Second moment of area around X axis )
...
Gmodulus = 6.57370e+02 # (Shear Modulus)
nu = 3.88867e-01 # (Poisson Ratio)
...
#
mdb.Job(name='include_mesh_DoE78', model='Model-1', type=ANALYSIS, explicitPrecision=SINGLE,
...
import os
mdb.jobs['include_mesh_DoE78'].writeInput(consistencyChecking=OFF)
