# Abaqus/CAE script
# Created by M.A. Bessa (M.A.Bessa@tudelft.nl) on 12-Nov-2019 03:49:01
#
from abaqus import *
...
#------------------------------------------------------------
os.chdir(r'/home/gkus/F3DAS-master/3_Analyses/DOE_Ix-PD-100/Input_point1/Imperfection_point1/DoE_point55')
#
#-------------------------------------------------------------
# Parameters:
...
MastPitch = 3.15045e+01 # Pitch length of the strut (i.e. a single AstroMast!)
...
Ix = 1.57033e+01 # (Second moment of area around X axis )
...
#
mdb.Job(name='include_mesh_DoE55', model='Model-1', type=ANALYSIS, explicitPrecision=SINGLE,
...
import os
mdb.jobs['include_mesh_DoE55'].writeInput(consistencyChecking=OFF)
