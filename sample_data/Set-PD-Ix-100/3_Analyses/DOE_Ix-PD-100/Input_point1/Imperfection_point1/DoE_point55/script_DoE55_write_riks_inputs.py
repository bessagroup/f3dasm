#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 03:49:54
#=====================================================================#
...
#
with open('DoE55_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE55']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE55.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE55_linear_buckle, STEP=1\n')
    mode_amplitude = 6.69132e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE55']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -3.15045e+01\n')
    File.write('** \n')
    File.write('** \n')
