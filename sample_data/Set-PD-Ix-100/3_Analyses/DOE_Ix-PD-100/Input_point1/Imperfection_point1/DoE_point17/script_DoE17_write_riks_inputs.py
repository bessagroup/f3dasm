#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 01:02:48
#=====================================================================#
...
#
with open('DoE17_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE17']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE17.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE17_linear_buckle, STEP=1\n')
    mode_amplitude = 6.46483e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE17']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -4.61717e+01\n')
    File.write('** \n')
    File.write('** \n')
