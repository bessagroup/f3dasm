#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 04:41:13
#=====================================================================#
...
#
with open('DoE58_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE58']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE58.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE58_linear_buckle, STEP=1\n')
    mode_amplitude = 7.47709e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE58']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -8.51039e+01\n')
    File.write('** \n')
    File.write('** \n')
