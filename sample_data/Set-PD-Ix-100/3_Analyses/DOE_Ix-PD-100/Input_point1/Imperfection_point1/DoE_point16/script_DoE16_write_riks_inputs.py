#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 01:02:00
#=====================================================================#
...
#
with open('DoE16_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE16']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE16.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE16_linear_buckle, STEP=1\n')
    mode_amplitude = 6.31325e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE16']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.16896e+02\n')
    File.write('** \n')
    File.write('** \n')
