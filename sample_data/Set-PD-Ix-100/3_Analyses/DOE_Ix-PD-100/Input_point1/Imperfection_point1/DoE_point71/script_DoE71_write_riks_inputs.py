#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 05:27:38
#=====================================================================#
...
#
with open('DoE71_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE71']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE71.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE71_linear_buckle, STEP=1\n')
    mode_amplitude = 5.59630e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE71']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -6.79916e+01\n')
    File.write('** \n')
    File.write('** \n')
