#=====================================================================#
#
# Created by M.A. Bessa on 11-Nov-2019 20:35:51
#=====================================================================#
...
#
with open('DoE5_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE5']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE5.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE5_linear_buckle, STEP=1\n')
    mode_amplitude = 7.36249e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE5']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.46858e+02\n')
    File.write('** \n')
    File.write('** \n')
