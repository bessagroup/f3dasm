#=====================================================================#
#
# Created by M.A. Bessa on 11-Nov-2019 20:34:44
#=====================================================================#
...
with open('DoE5_linear_buckle.inp','w') as File:
...
inputFile_string = '/home/gkus/F3DAS-master/3_Analyses/DOE_Ix-PD-100/Input_point1/Imperfection_point1/DoE_point5'+'/'+'DoE5_linear_buckle.inp'
job=mdb.JobFromInputFile(name='DoE5_linear_buckle', inputFileName=inputFile_string, 
