#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 06:12:58
#=====================================================================#
...
#
with open('DoE82_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE82']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE82.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE82_linear_buckle, STEP=1\n')
    mode_amplitude = 7.30398e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE82']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.29862e+02\n')
    File.write('** \n')
    File.write('** \n')
