#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 06:02:35
#=====================================================================#
...
#
with open('DoE80_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE80']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE80.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE80_linear_buckle, STEP=1\n')
    mode_amplitude = 6.32979e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE80']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -9.75443e+01\n')
    File.write('** \n')
    File.write('** \n')
