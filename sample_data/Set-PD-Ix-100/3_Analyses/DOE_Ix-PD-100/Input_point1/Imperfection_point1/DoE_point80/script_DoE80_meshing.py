# Abaqus/CAE script
# Created by M.A. Bessa (M.A.Bessa@tudelft.nl) on 12-Nov-2019 06:01:56
#
from abaqus import *
...
#------------------------------------------------------------
os.chdir(r'/home/gkus/F3DAS-master/3_Analyses/DOE_Ix-PD-100/Input_point1/Imperfection_point1/DoE_point80')
#
#-------------------------------------------------------------
# Parameters:
...
MastPitch = 9.75443e+01 # Pitch length of the strut (i.e. a single AstroMast!)
...
Ix = 3.93792e+01 # (Second moment of area around X axis )
...
Gmodulus = 6.57366e+02 # (Shear Modulus)
nu = 3.88877e-01 # (Poisson Ratio)
...
#
mdb.Job(name='include_mesh_DoE80', model='Model-1', type=ANALYSIS, explicitPrecision=SINGLE,
...
import os
mdb.jobs['include_mesh_DoE80'].writeInput(consistencyChecking=OFF)
