#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 03:53:25
#=====================================================================#
...
#
with open('DoE56_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE56']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE56.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE56_linear_buckle, STEP=1\n')
    mode_amplitude = 1.05143e-01/STRUCTURES_data['Input1']['Imperfection1']['DoE56']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.30678e+02\n')
    File.write('** \n')
    File.write('** \n')
