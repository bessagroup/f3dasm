#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 03:54:39
#=====================================================================#
...
#
with open('DoE57_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE57']['coilable'][0] == 0:
    ...
    File.write('*IMPERFECTION, FILE=DoE57_linear_buckle, STEP=1\n')
    mode_amplitude = 5.34883e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE57']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.10038e+02\n')
    File.write('** \n')
    File.write('** \n')
