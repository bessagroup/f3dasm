# Abaqus/CAE script
# Created by M.A. Bessa (M.A.Bessa@tudelft.nl) on 12-Nov-2019 03:53:53
#
from abaqus import *
...
MastPitch = 1.10038e+02 # Pitch length of the strut (i.e. a single AstroMast!)
...
Ix = 7.25543e+00 # (Second moment of area around X axis )
...
#
mdb.Job(name='include_mesh_DoE57', model='Model-1', type=ANALYSIS, explicitPrecision=SINGLE,
...
import os
mdb.jobs['include_mesh_DoE57'].writeInput(consistencyChecking=OFF)
