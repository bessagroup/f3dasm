#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 06:55:15
#=====================================================================#
...
#
with open('DoE97_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE97']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE97.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE97_linear_buckle, STEP=1\n')
    mode_amplitude = 6.54436e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE97']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -6.73052e+01\n')
    File.write('** \n')
    File.write('** \n')
