#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 03:40:38
#=====================================================================#
...
#
with open('DoE53_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE53']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE53.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE53_linear_buckle, STEP=1\n')
    mode_amplitude = 4.69456e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE53']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -8.96531e+01\n')
    File.write('** \n')
    File.write('** \n')
