#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 00:51:22
#=====================================================================#
...
#
with open('DoE14_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE14']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE14.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE14_linear_buckle, STEP=1\n')
    mode_amplitude = 6.58182e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE14']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -5.08961e+01\n')
    File.write('** \n')
    File.write('** \n')
