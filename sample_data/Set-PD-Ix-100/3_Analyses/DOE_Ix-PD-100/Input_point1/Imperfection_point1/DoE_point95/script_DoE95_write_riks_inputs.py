#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 06:45:11
#=====================================================================#
...
#
with open('DoE95_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE95']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE95.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE95_linear_buckle, STEP=1\n')
    mode_amplitude = 5.51267e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE95']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.03384e+02\n')
    File.write('** \n')
    File.write('** \n')
