#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 00:47:35
#=====================================================================#
...
#
with open('DoE13_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE13']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE13.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE13_linear_buckle, STEP=1\n')
    mode_amplitude = 8.29598e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE13']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.34480e+02\n')
    File.write('** \n')
    File.write('** \n')
