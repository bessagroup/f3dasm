#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 03:26:10
#=====================================================================#
...
#
with open('DoE48_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE48']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE48.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE48_linear_buckle, STEP=1\n')
    mode_amplitude = 8.06143e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE48']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -2.90287e+01\n')
    File.write('** \n')
    File.write('** \n')
