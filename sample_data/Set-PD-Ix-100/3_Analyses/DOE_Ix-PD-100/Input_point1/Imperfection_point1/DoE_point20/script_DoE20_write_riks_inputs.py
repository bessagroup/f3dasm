#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 01:13:43
#=====================================================================#
...
#
with open('DoE20_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE20']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE20.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE20_linear_buckle, STEP=1\n')
    mode_amplitude = 1.01640e-01/STRUCTURES_data['Input1']['Imperfection1']['DoE20']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -8.32753e+01\n')
    File.write('** \n')
    File.write('** \n')
