# Abaqus/CAE script
# Created by M.A. Bessa (M.A.Bessa@tudelft.nl) on 12-Nov-2019 05:30:33
#
from abaqus import *
...
MastPitch = 1.47776e+02 # Pitch length of the strut (i.e. a single AstroMast!)
...
Ix = 5.51544e+01 # (Second moment of area around X axis )
...
#
mdb.Job(name='include_mesh_DoE73', model='Model-1', type=ANALYSIS, explicitPrecision=SINGLE,
...
import os
mdb.jobs['include_mesh_DoE73'].writeInput(consistencyChecking=OFF)
