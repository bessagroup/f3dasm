#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 02:27:47
#=====================================================================#
...
#
with open('DoE31_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE31']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE31.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE31_linear_buckle, STEP=1\n')
    mode_amplitude = 8.70258e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE31']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -9.14788e+01\n')
    File.write('** \n')
    File.write('** \n')
