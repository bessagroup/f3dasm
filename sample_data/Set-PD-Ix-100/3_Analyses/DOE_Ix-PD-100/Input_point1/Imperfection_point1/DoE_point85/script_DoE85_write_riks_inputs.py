#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 06:20:42
#=====================================================================#
...
#
with open('DoE85_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE85']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE85.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE85_linear_buckle, STEP=1\n')
    mode_amplitude = 5.29447e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE85']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -4.84892e+01\n')
    File.write('** \n')
    File.write('** \n')
