#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 00:40:52
#=====================================================================#
...
#
with open('DoE10_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE10']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE10.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE10_linear_buckle, STEP=1\n')
    mode_amplitude = 1.51170e-01/STRUCTURES_data['Input1']['Imperfection1']['DoE10']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -2.83874e+01\n')
    File.write('** \n')
    File.write('** \n')
