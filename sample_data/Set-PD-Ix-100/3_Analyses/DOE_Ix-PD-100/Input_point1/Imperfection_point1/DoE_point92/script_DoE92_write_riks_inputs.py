#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 06:40:46
#=====================================================================#
...
#
with open('DoE92_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE92']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE92.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE92_linear_buckle, STEP=1\n')
    mode_amplitude = 6.91441e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE92']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -5.93607e+01\n')
    File.write('** \n')
    File.write('** \n')
