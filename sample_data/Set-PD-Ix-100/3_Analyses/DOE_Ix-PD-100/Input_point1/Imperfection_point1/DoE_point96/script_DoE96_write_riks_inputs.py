#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 06:53:58
#=====================================================================#
...
#
with open('DoE96_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE96']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE96.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE96_linear_buckle, STEP=1\n')
    mode_amplitude = 7.08383e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE96']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -8.24801e+01\n')
    File.write('** \n')
    File.write('** \n')
