#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 00:29:53
#=====================================================================#
...
#
with open('DoE8_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE8']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE8.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE8_linear_buckle, STEP=1\n')
    mode_amplitude = 7.41424e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE8']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.05852e+02\n')
    File.write('** \n')
    File.write('** \n')
