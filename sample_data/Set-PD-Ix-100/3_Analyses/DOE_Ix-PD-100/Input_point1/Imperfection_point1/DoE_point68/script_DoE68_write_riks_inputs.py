#=====================================================================#
#
# Created by M.A. Bessa on 12-Nov-2019 05:11:33
#=====================================================================#
...
#
with open('DoE68_riks.inp','wb') as File:
    if STRUCTURES_data['Input1']['Imperfection1']['DoE68']['coilable'][0] == 0:
    ...
    File.write('*INCLUDE, INPUT=include_mesh_DoE68.inp\n')
    File.write('** \n')
    ...
    File.write('*IMPERFECTION, FILE=DoE68_linear_buckle, STEP=1\n')
    mode_amplitude = 5.39197e-02/STRUCTURES_data['Input1']['Imperfection1']['DoE68']['maxDisp_p3'][1]
    ...
    File.write('RP_ZpYmXm, 3, 3, -1.18176e+02\n')
    File.write('** \n')
    File.write('** \n')
