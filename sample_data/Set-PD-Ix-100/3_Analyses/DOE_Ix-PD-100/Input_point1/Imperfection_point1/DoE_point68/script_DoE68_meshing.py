# Abaqus/CAE script
# Created by M.A. Bessa (M.A.Bessa@tudelft.nl) on 12-Nov-2019 05:10:58
#
from abaqus import *
...
#------------------------------------------------------------
os.chdir(r'/home/gkus/F3DAS-master/3_Analyses/DOE_Ix-PD-100/Input_point1/Imperfection_point1/DoE_point68')
#
#-------------------------------------------------------------
# Parameters:
...
MastPitch = 1.18176e+02 # Pitch length of the strut (i.e. a single AstroMast!)
...
Ix = 9.20051e+00 # (Second moment of area around X axis )
...
Gmodulus = 6.57362e+02 # (Shear Modulus)
nu = 3.88885e-01 # (Poisson Ratio)
...
#
mdb.Job(name='include_mesh_DoE68', model='Model-1', type=ANALYSIS, explicitPrecision=SINGLE,
...
import os
mdb.jobs['include_mesh_DoE68'].writeInput(consistencyChecking=OFF)
